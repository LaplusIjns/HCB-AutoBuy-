...
public class LastJDBCTemplate {
    ...
    private static String GET_DAILY= """
            ...
            """;
    private static String GET_SINYA_DAILY= """
    ...
    public List<DailyDTO2> getDaily(Integer index,Integer index2){
        ...
        List<DailyDTO2> x = namedParameterJdbcTemplate.query(GET_DAILY, sqlParameterSource,new BeanPropertyRowMapper<>(DailyDTO2.class));
        return x;
    }
    
    public List<DailyDTO2> getSinyaDaily(Integer index,Integer index2){
        SqlParameterSource sqlParameterSource = new MapSqlParameterSource().addValue("?1", index).addValue("?2", index2);
        List<DailyDTO2> x = namedParameterJdbcTemplate.query(GET_SINYA_DAILY, sqlParameterSource,new BeanPropertyRowMapper<>(DailyDTO2.class));
        return x;
    }
}
